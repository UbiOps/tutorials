...
| [Jupyter Server with Services](jupyter-services/jupyter-services.md)                                                                                         |Deployment, Services, Jupyter                                              |
| [vLLM Chat with Services](vllm-chat-services/vllm-chat-services.md)                                                                                          |Deployment, Services, vLLM                                                 |
|[Deploy an Nvidia optimized vLLM Server](vllm-ngc-tutorial/vllm-ngc-tutorial.md)                                                                              |Deployment, Services, OpenAI-compatibility, chat-completion, vLLM, Nvidia  |
| [Deploy OpenTelemetry Observability Stack on UbiOps with Docker and Services](fastapi-otl-tutorial/fastapi-otl-tutorial.md)                                  | Docker, Services, FastAPI, Opentelemetry                                  |
| [Document Annotation Pipeline using Haystack](haystack-annotation/haystack-annotation.md                  )                                                  | Deployment, Pipeline,                                                      |
